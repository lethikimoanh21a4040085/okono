    ...
    public partial class FrmThongKe : Form
    {
        ...
        private void btnIn_Click(object sender, EventArgs e)
        {
            if(ckTopdau.Checked==true && btnThang.Enabled==true)
            {
                ...
                /*sql = "SELECT a.MaHoaDonNhap, a.NgayNhap, b.TenNhanVien FROM HoaDonNhap AS a INNER JOIN NhanVien AS b ON a.MaNhanVien = b.MaNhanVien WHERE a.MaHoaDonNhap = N'" + txtMaHD.Text + "'";
