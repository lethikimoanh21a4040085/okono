...
namespace Okono
{
    public partial class FrmPhieuDieuChuyen : Form
    {
        ...
        private void InitDatabase()
        {
            try
            {
                ...
                string sanPhamQuery = "SELECT MaSanPham AS 'Mã Sản Phẩm', TenSanPham AS 'Tên Sản Phẩm'," +
                    ...
                    " FROM SanPham LEFT JOIN DonViTinh ON SanPham.MaDonViTinh = DonViTinh.MaDonViTinh where DaXoa=0";
                ...
                string nhanVienQuery = "SELECT MaNhanVien, TenNhanVien FROM NhanVien where DaXoa=0";
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            {
                // Lay danh sach san pham
                string spQuery = "SELECT MaSanPham, SoLuongTon FROM SanPham WHERE DaXoa = 0";
