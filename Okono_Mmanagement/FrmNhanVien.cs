...
namespace Okono
{
    public partial class FrmNhanVien : Form
    {
        ...
        private void FrmNhanVien_Load(object sender, EventArgs e)
        {
            ...
            string caLamViecSql = "SELECT MaCaLamViec, TenCaLamViec FROM CaLamViec";
            ...
            string chucVuSql = "SELECT MaChucVu, TenChucVu FROM ChucVu";
            ...
            string diaChiSql = "SELECT MaCoSo, TenCoSo FROM CoSo";
