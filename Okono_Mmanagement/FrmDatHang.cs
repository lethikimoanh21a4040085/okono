    ...
    public partial class FrmDatHang : Form
    {
        ...
        private void LoadDataToGridviewSP()
        {
            ...
            sql = "SELECT MaSanPham, TenSanPham, SoLuongTon,b.TenDonViTinh " +
                "FROM SanPham a join DonViTinh b on a.MaDonViTinh=b.MaDonViTinh where DaXoa=0";
 ...
 "'," + numSoLuong.Value + ")";
        ...
        private void btnTimSP_Click(object sender, EventArgs e)
        {
            ...
            sql = "SELECT a.MaSanPham, TenSanPham, SoLuongTon, b.TenDonViTinh " +
                "FROM SanPham a join DonViTinh b on a.MaDonViTinh =b. MaDonViTinh where 1 = 1 and DaXoa = 0 ";
            if (txtTimKiem.Text != "")
            {
